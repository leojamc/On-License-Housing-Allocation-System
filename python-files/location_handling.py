...
class LicenseeLocation(Location):
    ...
    def get_location_status(self): #Getter for licensee_location_status
        return self.__licensee_location_status
    def set_location_status(self, new_location_status): #Setter for location_status
